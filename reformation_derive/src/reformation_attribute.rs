use syn::{Attribute, Expr, AttrStyle};
use syn::punctuated::Punctuated;
use proc_macro2::Span;
use syn::parse::{Parse, ParseStream};
use syn::spanned::Spanned;
use crate::syn_helpers::{expr_into_attribute_param, expr_bool_lit, get_regex_str};
...
impl Modes{
    fn apply(&mut self, expr: &Expr) -> syn::Result<()>{
        ...
        match name.as_str() {
            ...
            _ => {
                Err(errors::attribute_unknown_mode(expr.span(), &name))
            }
        }
    }
